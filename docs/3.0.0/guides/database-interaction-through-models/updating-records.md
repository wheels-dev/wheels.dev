...
This chapter will focus on how to update records. Read the [Creating Records](/3.0.0/guides/database-interaction-through-models/creating-records) chapter for more information about how to create new records.
