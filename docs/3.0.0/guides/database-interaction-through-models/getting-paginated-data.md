...
This chapter will deal with the first part: getting the paginated data. Please proceed to the chapter called [Displaying Links for Pagination](/3.0.0/guides/displaying-views-to-users/displaying-links-for-pagination) if you wish to learn how to output the page links in your view.
...
Don't forget to check the chapter [Displaying Links for Pagination](/3.0.0/guides/displaying-views-to-users/displaying-links-for-pagination).
