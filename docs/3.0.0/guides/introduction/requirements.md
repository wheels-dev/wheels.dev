...
Don't worry though. Wheels will adopt to your setup and run just fine, but the URLs that it creates might differ a bit. You can read more about this in the [URL Rewriting](/3.0.0/guides/handling-requests-with-controllers/url-rewriting/README) chapter.
...
* We also recommend using the InnoDB engine if you want [Transactions](/3.0.0/guides/database-interaction-through-models/transactions) to work.
