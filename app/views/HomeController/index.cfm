<main class="main">
    ...
    <div class="container pb-5">
        <div class="row g-5">
            <div class="col-lg-4">
                <div
                    ...
                    <div class="mt-3">
                        ...
                        <p class="fs-18 text--secondary/70 pt-1">A full framework with tonnes of functionality -
                            once ...</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div
                    class="px-4 pt-4 pb-2 bg-white border-transparent border-2 cards rounded-5 shadow-sm cursor-pointer">
                    <div class="icon-container d-flex justify-content-center align-items-center">
                    ...
                    <div class="mt-3">
                        ...
                        <p class="fs-18 text--secondary/70 pt-1">Resource based routing for GET, POST, PUT, PATCH
                            & DELETE</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div
                    ...
                    <div class="mt-3">
                        ...
                        <p class="fs-18 text--secondary/70 pt-1">Built in database migration system even across
                            different...
                        </p>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div
                    ...
                    <div class="mt-3">
                        <p class="fw-bold fs-24 text--secondary">Automatic Doc</p>
                        <p class="fs-18 text--secondary/70 pt-1">A full framework with tonnes of functionality -
                            once ...</p>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div
                    ...
                    <div class="mt-3">
                        ...
                        <p class="fs-18 text--secondary/70 pt-1">Switch in and out of Wheels conventions - it's
                            your call;...
                        </p>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div
                    ...
                    <div class="mt-3">
                        ...
                        <p class="fs-18 text--secondary/70 pt-1">Wheels uses industry established concepts, such
                            as ...
                        </p>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div
                    ...
                    <div class="mt-3">
                        ...
                        <p class="fs-18 text--secondary/70 pt-1">Get in touch via our GitHub Discussions - we're
                            newbie ...
                        </p>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div
                    ...
                    <div class="mt-3">
                        ...
                        <p class="fs-18 text--secondary/70 pt-1">Stop thinking about how to organize your code and
                            deal ...
                        </p>
                    </div>
                </div>
