<cfoutput>
    <div class="categoryResponce container py-5">
        <div class="row mb-4 gx-6 gy-3 align-items-center">
            <div class="col-auto">
                <h1 class="fs-24 fw-bold">Categories</h1>
            </div>
            <div class="col-auto">
                <a class="btn btn-primary px-5" hx-get="/admin/category/add" hx-trigger="click" hx-target="body" hx-swap="innerHTML"><i class="fa-solid fa-plus me-2"></i>Add Category</a>
            </div>
        </div>
        <table id="categoryTable" class="table table-hover mb-5">
            <thead>
                <tr>
                    <th>No.</th>
                    <th>Name</th>
