        ...
        <cfoutput>
            <div class="container">
                ...
                <cfif structKeyExists(params, "welcomeMessage") AND params.welcomeMessage neq "">
                    <h1 class="mt-4">#encodeForHTML(params.welcomeMessage)#</h1>
                </cfif>
                <cfif structKeyExists(params, "name")>
                    <h2 class="mt-4">Dear #encodeForHTML(params.name)#</h2>
                </cfif>
                <cfif structKeyExists(params, "subject")>
                    <h2 class="mt-4">#encodeForHTML(params.subject)#</h2>
                </cfif>
                <p class="mb-4">#params.content#</p>
                <cfif structKeyExists(params, "buttonTitle") and params.buttonTitle neq "">
                    <a href="#encodeForHTMLAttribute(params.URl)#" class="button"> #encodeForHTML(params.buttonTitle)# </a>
                </cfif>
                <cfif structKeyExists(params, "footerNote") and params.footerNote neq "">
                    <p class="footer">#encodeForHTML(params.footerNote)#</p>
                </cfif>
                ...
                <cfif structKeyExists(params, "footerGreetings") AND params.footerGreetings neq "">
                    <p class="mb-4" style="font-size: 14px;">#encodeForHTML(params.footerGreetings)#</p>
                </cfif>
                ...
                <cfif structKeyExists(params, "closingRemark") and params.closingRemark neq "">
                    <p style="font-size: 14px;">#encodeForHTML(params.closingRemark)#</p>
                </cfif>
                <cfif structKeyExists(params, "teamSignature") and params.teamSignature neq "">
                    <h5 style="margin-top: 5px !important; font-size: 14px;">#encodeForHTML(params.teamSignature)#<h5>
                </cfif>
