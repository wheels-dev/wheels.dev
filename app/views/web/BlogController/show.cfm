                ...
                <div class="bg-white rounded-5 shadow-sm mt-4 p-4">
                    <div class="row gy-4">
                        ...
                        <div class="col-lg-5 col-12 text-lg-end text-center">
                            <img src="#attachments.path#" class="img-fluid size-320 mx-auto rounded-4"
                                alt="blog-detail">
                        </div>
                            ...
                            <div class="position-relative parent_comment">
                                <div class="d-flex align-items-start gap-3">
                                    ...
                                    <div class="p-3 rounded-4 bg-light">
                                        <h6 class="fs-16 fw-bold">Peter</h6>
                                        <p class="fs-14 fw-normal text-dark">In mauris porttitor tincidunt mauris
                                            massa sit lorem sed scelerisque. Fringilla pharetra vel massa enim sollicitudin
                                            cras. At pulvinar eget sociis adipiscing eget donec ultricies nibh tristique.
                                        </p>
                                        <div class="d-flex justify-content-end align-items-center gap-4">
                                            ...
                                            <div class="d-flex cursor-pointer align-items-center gap-2">
                                                <p class="fs-14 text--iris mb-0">Feb 14, 2025</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
