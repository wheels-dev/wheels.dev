<cfcontent type="application/rss+xml; charset=utf-8"><cfheader name="Content-Type" value="application/rss+xml; charset=utf-8"><?xml version="1.0" encoding="UTF-8"?><rss version="2.0"
...
<cfoutput>
	...
	<lastBuildDate>#dateFormat(now(), "ddd, dd mmm yyyy")# #timeFormat(now(), "HH:mm:ss")# +0000</lastBuildDate>
	...
	<cfloop query="#blogPosts#">
		<cfset strippedContent = reReplace(blogPosts.content, "<[^>]*>", "", "all")><cfset shortDescription = left(strippedContent, 160)><cfset category = this.getCategoriesByBlogid(blogPosts.id)><item>
			...
			<content:encoded><![CDATA[#blogPosts.content#]]></content:encoded>
		</item>
	</cfloop>
</cfoutput>
</channel>
