<main>
    ...
    <div class="w-100 h-600 position-relative feature-blog">
        <div class="position-absolute mx-auto container start-0 end-0 bottom-50px">
            ...
            <p class="text-white fw-bold fs-36 pb-3 line-height-100">Neque porro quisquam est qui dolorem
                ipsum quia dolor sit amet, consectetur, adipisci velit.</p>
            <p class="text-white opacity-50 fs-18">It is a long established fact that a reader will be distracted by the
                readable content
    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-center">
            <div id="loader-wrapper" style="width: 4rem; height: 4rem;" class="spinner-border my-5 text-danger"
                role="status">
        ...
        <div class="pt-4">
            ...
            <div class="row justify-content-center justify-content-lg-between">
                ...
                <div id="filtersContainer" class="col-lg-2 order-lg-0 order-first col-12 p-lg-0 d-none">
                    ...
                    <div class="d-none bg-white p-3 text-center shadow-sm border rounded-18 no-scrollbar h-70vh overflow-y-auto" id="Archives">
                        <!-- Archives Button -->
                        <cfoutput>
                    ...
                    <div class="d-none bg-white p-3 text-center shadow-sm border rounded-18" id="Categories"
    ...
    <div class="d-flex pb-5 justify-content-center">
        <div id="loader" style="display:none; width: 4rem; height: 4rem;" class="spinner-border text-danger"
            role="status">
            <span class="visually-hidden">Loading...</span>
        </div>
    </div>
