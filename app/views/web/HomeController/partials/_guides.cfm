                ...
                <div class="col-8">
                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="v-pills-command" role="tabpanel"
                            ...
                            <p class="fs-18 text-white">
                                The command line tools extends the functionality of <a href="https://www.ortussolutions.com/products/commandbox">CommandBox</a> with some commands specifically designed for Wheels development.<a href="https://www.ortussolutions.com/products/commandbox">CommandBox</a> brings a whole host of command line capabilities to the CFML developer. It allows you to write scripts that can be executed at the command line written entirely in CFML. It allows you to start a CFML server from any directory on your machine and wire up the code in that directory as the web root of the server. What's more is, those servers can be either Lucee servers or Adobe ColdFusion servers. You can even specify what version of each server to launch. Lastly, CommandBox is a package manager for CFML. That means you can take some CFML code and package it up into a module, host it on ForgeBox.io, and make it available to other CFML developers. In fact we make extensive use of these capabilities to distribute Wheels plugins and templates. More on that later.One module that we have created is a module that extends CommandBox itself with commands and features specific to the Wheels framework. The Wheels CLI module for CommandBox is modeled after the Ruby on Rails CLI module and gives similar capabilities to the Wheels developer.
                            </p>
                            <div class="d-flex justify-content-end">
                                <button class="bg--primary fs-16 fw-semibold px-3 py-1 rounded text-white">Learn
                                    more</button>
