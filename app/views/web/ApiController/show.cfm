                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li class="dropdown-item fs-14 cursor-pointer">#linkTo(route="docFunction", encode="attributes", version=params.version, slug=meta.slug, format="html", text="Permalink", target="_blank")#</li>
                            <li class="dropdown-item fs-14 cursor-pointer">#linkTo(route="docFunction", encode="attributes", version=params.version, slug=meta.slug, format="json", text="JSON", target="_blank")#</li>
                        </ul>
                    </div>
                </div>
                <div>
