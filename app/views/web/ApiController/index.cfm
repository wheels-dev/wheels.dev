<main class="main-bg">
    <div class="container py-5">
        ...
        <div class="row justify-content-center justify-content-lg-between">
            <div id="apiContainer" class="p-3 rounded-18 bg-white mt-lg-0 mt-3 col-12">
                ...
                <div class="mt-4">
                    <table class="table table-responsive">
                        <thead class="table--iris">
                            <tr>
                                <th scope="col" class="text-white px-5 fs-14 fw-semibold">Name</th>
                                <th scope="col" class="text-white px-5 fs-14 fw-semibold">Type</th>
                                <th scope="col" class="text-white px-5 fs-14 fw-semibold">Required</th>
                                <th scope="col" class="text-white px-5 fs-14 fw-semibold">Default</th>
                                <th scope="col" class="text-white px-5 fs-14 fw-semibold">Description</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td class="text-black py-3 px-5 fs-14 fw-normal">Properties</td>
                                <td class="text-black py-3 px-5 fs-14 fw-normal">String</td>
                                <td class="text-black py-3 px-5 fs-14 fw-normal">No</td>
                                <td class="text-black py-3 px-5 fs-14 fw-normal">No</td>
                                <td class="text-black py-3 px-5 fs-14 fw-normal">Property name (or list of property
                                    names)
                                    that are allowed</td>
                            </tr>
                            ...
                            <div id="introduction" class="accordion-collapse collapse show"
                                ...
                                <div class="accordion-body pb-0 space-y-3 pt-3 px-0 position-relative">
                                    <div class="space-y-3 ps-4">
                                        <p class="fs-14 fw-normal text--iris">Miscellanious Functions</p>
                                        <p class="fs-14 fw-normal text--iris">Routing</p>
                                    </div>
                                </div>
                            </div>
                        </div>
