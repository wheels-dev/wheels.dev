            ...
            <div class="col-lg-3 col-12 mb-lg-0 mb-5 order-lg-last order-first">
                <div class="d-flex d-none api flex-wrap align-items-center justify-content-end gap-3">
                    <button
                        ...
                        class="active px-4 filter-button fs-16 py-2 d-flex align-items-center gap-2 rounded-3 border border--primary bg-transparent text--secondary">
                    ...
                    <button
                        ...
                        class="px-4 filter-button fs-16 py-2 d-flex align-items-center gap-2 rounded-3 border border--primary bg-transparent text--secondary">
                        Sections
