...
*/
component extends="wheels.migrator.Migration" hint="create blog_created_date column" {

	function up() {
		transaction {
			try {
				addColumn(table = 'blog_posts', columnType = 'date', columnName = 'post_created_date', default = '', null = true);
			} catch (any e) {
				local.exception = e;
			}
	...
	function down() {
		transaction {
			try {
				removeColumn(table = 'blog_posts', columnName = 'post_created_date');
			} catch (any e) {
				local.exception = e;
			}
